...
interest_profile = {
    ...
    "interest_summary": (
        "The student shows a broad interest in "
        "software engineering, programming and technology."
    ),
    "evidence": [
        "Java developer meme",
...
print("Interest profile loaded.")
print("Calling Gemini recommendation engine...")
